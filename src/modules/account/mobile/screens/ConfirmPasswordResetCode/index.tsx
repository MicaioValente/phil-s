...
import { useConfirmPasswordResetCodeForm } from '@modules/account/business/forms';
...
function ConfirmPasswordResetCode() {
  ...
  const { control, isLoading, onSubmit } = useConfirmPasswordResetCodeForm();
...
export default {
  name: 'account/confirm-password-reset-code',

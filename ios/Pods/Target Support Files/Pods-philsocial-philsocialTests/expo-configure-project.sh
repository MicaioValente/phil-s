...
with_node \
  ...
  --target "/Users/micaiovalente/Projects/keltech/philsocial/ios/Pods/Target Support Files/Pods-philsocial-philsocialTests/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient"
